...
echo "=================================================="
echo "⚡ LUMEN MOBILE: NATIVE iOS .IPA COMPILATION (v2.1.0)"
echo "=================================================="
...
static int appDidFinishLaunching(id self, SEL _cmd, id application, id launchOptions) {
    ...
    ((void (*)(id, SEL, id))f_objc_msgSend)(subLabel, f_sel_registerName("setText:"), create_str("● SENSORS STREAMING · LOCAL BUFFER ARMED (v2.1.0)"));
